    ...
    useEffect(() => {
        ...
        const fetchProducto = async () => {
            try {
                ...
                setSelectedCategoria(producto.id_categoria);
                setSelectedProveedor(producto.id_proveedor);
            } catch (error) {
    ...
    return (
        <div className="w-4/5 mx-auto p-10 border border-gray-300 rounded-lg bg-beige-100">
            ...
            <div className="mb-6">
                ...
                {" / "}
                <Link to="/principal/producto/edit" className="text-blue-500 hover:underline font-bold">
                    EDITAR
                </Link>
            </div>
            <ToastContainer />
